...
st.set_page_config(page_title="FX 蜍晉紫迚ｹ蛹悶ム繝・す繝･繝懊・繝・, layout="wide", page_icon="嶋")
...
def get_ai_prediction_cached(data_summary, ticker_name, api_key):
    ...
    3. **繧ｨ繝ｳ繝医Μ繝ｼ蝓ｺ貅・*: 譏守｢ｺ縺ｪ繝医Ξ繝ｳ繝峨・譁ｹ蜷代√∪縺溘・蠑ｷ蜉帙↑繝ｬ繧ｸ繧ｵ繝晁ｻ｢謠帙ｒ閠・・縺励√・繝ｭ縺ｨ縺励※蠢・★縲恵uy・郁ｲｷ縺・ｼ峨阪∪縺溘・縲茎ell・亥｣ｲ繧奇ｼ峨阪・縺・★繧後°繧帝∈謚槭＠縺ｦ縺上□縺輔＞縲・
