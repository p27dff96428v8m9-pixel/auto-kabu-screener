...
load_dotenv()
default_key = os.environ.get("GEMINI_API_KEY", "AIzaSyBZcVHskR4aP4uv_V_tNi8tFsvW1Ty8BWg")
if not default_key:
...
```""")
                        webhook_url = st.text_input("GAS デプロイ済みのウェブアプリURL", type="password", value="https://script.google.com/macros/s/AKfycbwYdaaV1bDj4Is3Z4e0364frK-Xr_4qVbJKG1a25QYTk4D4kIPBsqu443nVF09MWUid/exec")
